...
{
    public class GetRefrralStatus
    {
        //public async Task<xxxResponse> XXXXRequestAsync(string Token)
        //{
        //    try
        //    {
        //        //insert request here
        ...
        //        try
        //        {
        //            var result = JsonConvert.DeserializeObject<xxxResponse>(response.Content);
